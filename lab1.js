...
//your code goes here
var animalName = 'monkey';
assert(animalName === 'monkey', 'AnimalName\'s value is monkey - this assert will pass.');
assert(animalName === 'bear', 'Monkey is not bear.');
/* ========================================================================
...
assert(animalExhibitStats.mostPopular === 'Lucky the Emperor Penguin', 'Penguin is the most popular animal.');
/* ==================================================================
